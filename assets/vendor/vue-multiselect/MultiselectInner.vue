      ...
      <ul
        ...
        <li v-if="multiple && max === internalValue.length">
            <span class="multiselect__option">
              <slot name="maxElements">Максимум из {{ max
                }} элементов выбрано. Уберите один из них, чтобы выбрать новый.</slot>
            </span>
        </li>
        ...
        <li v-show="filteredOptions.length === 0 && search && !loading">
            <span class="multiselect__option">
              <slot name="noResult">Не найднено ни одного элемента. Попробуйте изменить запрос.</slot>
            </span>
        </li>
...
//        default: 'Выбрано'
    ...
    methods: {
      // innerActivate () {
      //   console.log(this.searchable, (this.search ? 'es' : 'ni'))
      //   if (this.search) this.activate()
      //   // this.activate()
      // },
      // innerFocus () {
      //   this.$refs.search.focus()
      // },
      // innerUpdateSearch (input) {
...
<style lang="scss" scoped>
  $lux-blue: #0c6fbb;
  /*$select-color: #41B883;*/
  $select-color: $lux-blue;
  /*$select-highlight: #369a6e*/
  $select-highlight: lighten($select-color, 20%);
